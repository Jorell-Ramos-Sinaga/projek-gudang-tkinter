...
class AppPage(tk.Frame):
	...
	def create_right_frame(self):
		self.right_frame = tk.Frame(self, bg="khaki", width=2*self.settings.width//3)
	...
	def create_left_header(self):
		...
		self.entry_search = tk.Entry(self.search_box_frame, bg="white", fg="black", font=("Times New Roman", 12), textvariable=self.entry_search_var)
		self.entry_search.grid(row=0, column=0)

		self.button_search = tk.Button(self.search_box_frame, bg="white", fg="black", text="Find", font=("Times New Roman", 12), command=self.clicked_search_btn)
	...
	def create_left_content(self):
		...
		self.database_list_box = tk.Listbox(self.left_content, bg="white", fg="black", font=("Times New Roman", 12), height=frame_h)
	...
	def create_detail_right_header(self):
		...
		self.fulitemmerk_label = tk.Label(self.detail_header, text=fulitemmerk, font=("Times New Roman", 30), width=frame_w, height=frame_h, image=self.virt_img, compound='c', bg="khaki")
	...
	def create_right_content(self):
		...
		self.right_content = tk.Frame(self.right_frame, width=frame_w, height=frame_h, bg="khaki")
	...
	def create_detail_right_content(self):
		...
		self.detail_content = tk.Frame(self.right_content, width=frame_w, height=frame_h, bg="khaki")
		...
		for row in range(rows):
			...
			for column in range(columns):
				label = tk.Label(self.detail_content, text=info[row][column], font=("Times New Roman", 12), bg="khaki")
				aRow.append(label)
				if column == 0:
					sticky = "e"
				else:
	...
	def create_right_footer(self):
		...
		self.right_footer = tk.Frame(self.right_frame, width=frame_w, height=frame_h, bg="khaki")
	...
	def create_detail_right_footer(self):
		...
		self.detail_footer = tk.Frame(self.right_footer, width=frame_w, height=frame_h, bg="khaki")
		...
		for feature in features:
			button = tk.Button(self.detail_footer, text=feature, bg="khaki", fg="black", bd=0, font=("Times New Roman", 12, "bold"), command=commands[features.index(feature)])
	...
	def clicked_update_btn(self):
		...
		self.detail_update_content = tk.Frame(self.right_content, width=frame_w, height=frame_h, bg="khaki")
		...
		for row in range(rows):
			...
			for column in range(columns):
				if column == 0:
					label = tk.Label(self.detail_update_content, text=info[row][column], font=("Times New Roman", 12), bg="khaki")
					sticky = "e"
					aRow.append(label)
					label.grid(row=row, column=column, sticky=sticky)
				else:
					entry = tk.Entry(self.detail_update_content, font=("Times New Roman", 12), bg="khaki", textvariable=self.entry_update_data_vars[row])
		...
		self.detail_update_footer = tk.Frame(self.right_footer, width=frame_w, height=frame_h, bg="khaki")
		...
		self.buttons_features = []
		for feature in features:
			button = tk.Button(self.detail_update_footer, text=feature, bg="khaki", fg="black", bd=0, font=("Times New Roman", 12, "bold"), command=commands[features.index(feature)])
			button.grid(row=0, column=features.index(feature), sticky="nsew", padx=20)
			self.buttons_features.append(button)
	...
	def clicked_add_new_btn(self):
		...
		self.virt_img = tk.PhotoImage(width=1, height=1)
		self.add_new_label = tk.Label(self.detail_add_new_header, text="Add New Product", font=("Times New Roman", 30), width=frame_w, height=frame_h, image=self.virt_img, compound='c', bg="khaki")
		...
		self.detail_add_new_content = tk.Frame(self.right_content, width=frame_w, height=frame_h, bg="khaki")
		...
		for row in range(rows):
			...
			for column in range(columns):
				if column == 0:
					label = tk.Label(self.detail_add_new_content, text=info[row][column], font=("Times New Roman", 12), bg="khaki")
					sticky = "e"
					aRow.append(label)
					label.grid(row=row, column=column, sticky=sticky)
				else:
					entry = tk.Entry(self.detail_add_new_content, font=("Times New Roman", 12), bg="khaki", textvariable=self.entry_update_data_vars[row])
					sticky = "w"
					aRow.append(entry)
					entry.grid(row=row, column=column, sticky=sticky)
			self.table_info.append(aRow)
		...
		self.detail_add_new_footer = tk.Frame(self.right_footer, width=frame_w, height=frame_h, bg="khaki")
		...
		self.buttons_features = []
		for feature in features:
			button = tk.Button(self.detail_add_new_footer, text=feature, bg="khaki", fg="black", bd=0, font=("Times New Roman", 12, "bold"), command=commands[features.index(feature)])
			button.grid(row=0, column=features.index(feature), sticky="nsew", padx=20)
			self.buttons_features.append(button)
